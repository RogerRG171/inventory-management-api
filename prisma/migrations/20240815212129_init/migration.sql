...
CREATE TABLE "ExpensesSummary" (
    ...
    CONSTRAINT "ExpensesSummary_pkey" PRIMARY KEY ("expenseSummaryId")
);
...
CREATE TABLE "PurchasesSummary" (
    ...
    CONSTRAINT "PurchasesSummary_pkey" PRIMARY KEY ("purchaseSummaryId")
);
...
CREATE TABLE "ExpensesByCategory" (
    ...
    CONSTRAINT "ExpensesByCategory_pkey" PRIMARY KEY ("expenseByCategoryId")
);
...
-- AddForeignKey
ALTER TABLE "ExpensesByCategory" ADD CONSTRAINT "ExpensesByCategory_expenseSummaryId_fkey" FOREIGN KEY ("expenseSummaryId") REFERENCES "ExpensesSummary"("expenseSummaryId") ON DELETE RESTRICT ON UPDATE CASCADE;
